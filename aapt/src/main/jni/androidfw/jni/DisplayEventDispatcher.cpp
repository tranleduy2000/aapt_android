...
//                ALOGE("dispatcher %p ~ last event processed while scheduling was for %"
//                              PRId64
//                              "",
...
//        }
    ...
    int DisplayEventDispatcher::handleEvent(int, int events, void *) {
        ...
        uint32_t vsyncCount;
        if (processPendingEvents(&vsyncTimestamp, &vsyncDisplayId, &vsyncCount)) {
            ALOGV("dispatcher %p ~ Vsync pulse: timestamp=%"
                          PRId64
                          ", id=%d, count=%d",
...
//                        break;
//                    default:
//                        ALOGW("dispatcher %p ~ ignoring unknown event type %#x", this,
//                              ev.header.type);
//                        break;
//                }
//            }
